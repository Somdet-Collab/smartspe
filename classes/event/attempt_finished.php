...
class attempt_finished extends \core\event\base
{
    ...
    {
        return get_string('eventevaluationfinished', 'mod_smartspe');
    }

    public function get_description()
    {
        return "The user with id '{$this->userid}' finished evaluation for attempt id '{$this->objectid}' in SmartSPE instance '{$this->contextinstanceid}'.";
    }
