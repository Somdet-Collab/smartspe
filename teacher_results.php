...
echo '<a href="download_results.php?id=' . $cmid . '&type=csv&sentiment=false" class="btn btn-primary me-2">
        <i class="fa fa-download"></i> Download All Evaluation Responses (CSV)
      </a>';
echo '<a href="download_results.php?id=' . $cmid . '&type=xlsx&sentiment=true" class="btn btn-success me-2">
        <i class="fa fa-file-excel-o"></i> Download Grading Summary (XLSX)
      </a>';
echo '<a href="download_results.php?id=' . $cmid . '&type=csv&sentiment=true" class="btn btn-primary me-2">
